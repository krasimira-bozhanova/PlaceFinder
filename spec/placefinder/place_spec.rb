...
describe "Place" do
  ...
  describe "add_place" do
    it "adds a place successfully" do
      expect do
        Place.add_place(:name => "The place", :address_id => 1, :type_id => 1)
  ...
  describe 'get_place' do
    it 'gets the correct place' do
      ...
      Place.get_place(:name => "Cool place", :address_id => 1, :type_id => 1).should == {
        "name"=>"Cool place",
        "address_id"=>1,
        "type_id"=>1,
  ...
  describe 'get_all_places_with_type' do
    ...
    it 'works with places of the same type' do
      FactoryGirl.create(:place)
      Place.add_place(:name => "Other place", :address_id => 2, :type_id => 2)
